              ...
              <article key={post._id} className="post-card" style={{ background: '#fff', borderRadius: '1rem', boxShadow: '0 2px 12px rgba(0,0,0,0.07)', padding: '2rem', display: 'flex', flexDirection: 'column', minHeight: 260 }}>
                <div className="post-meta" style={{ display: 'flex', alignItems: 'center', marginBottom: 12 }}>
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <span className="date" style={{ color: '#888', marginLeft: 12 }}>{formatDate(post.createdAt)}</span>
                  </div>
                ...
                <div style={{ flex: 1 }} />
                <div className="post-footer" style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginTop: 12 }}>
                  <div className="post-stats">
                    <button
                      className="like-btn"
                      style={{ background: 'none', border: 'none', cursor: 'pointer', color: post.likes.includes(user?.id) ? '#eab308' : '#888', fontSize: 20, marginRight: 8 }}
